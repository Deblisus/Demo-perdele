...
function ComboboxTrigger({
  ...
  return (
    <ComboboxPrimitive.Trigger
      ...
      className={cn(
        "absolute right-0 flex h-8 w-8 items-center justify-center rounded-r-lg text-muted-foreground outline-none disabled:pointer-events-none disabled:opacity-50",
        className
      )}
      {...props}
    >
...
function ComboboxEmpty({ className, ...props }: ComboboxPrimitive.Empty.Props) {
  return (
    <ComboboxPrimitive.Empty
      ...
      className={cn(
        "px-1.5 py-2 text-center text-sm text-muted-foreground empty:m-0 empty:p-0",
        className
      )}
      {...props}
    />
